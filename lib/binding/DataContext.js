...
function DataContextProvider(props) {
    var _a;
    var _b = react_1.useState(props.context), context = _b[0], setContext = _b[1];
    var updateContext = function (value) {
        var _a;
        console.log("updateConstex - " + JSON.stringify((_a = value.products) === null || _a === void 0 ? void 0 : _a.length));
        setContext(value);
        if (props.onChange) {
            props.onChange(value);
        }
    };
    console.log("datacontex - " + JSON.stringify((_a = context.products) === null || _a === void 0 ? void 0 : _a.length));
    if (props.contextKey) {
